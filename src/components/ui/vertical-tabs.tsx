...
export function VerticalTabs() {
  ...
  useEffect(() => {
    if (isPaused) return;
    const interval = setInterval(handleNext, AUTO_PLAY);
    ...
    <section className="w-full py-10 md:py-20">
      <div className="w-full px-6 md:px-10 lg:px-16 xl:px-24 mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          {/* Left: Tab list */}
          <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 pt-4 lg:min-h-[660px]">
            <div className="mb-10">
                      ...
                      <AnimatePresence initial={false}>
                        {isActive && (
                          <motion.p
                            ...
                            className="text-[#81c784] text-sm md:text-base leading-relaxed max-w-sm overflow-hidden pb-1"
                          >
                            {service.description}
                          </motion.p>
                        )}
          ...
          >
            <div className="relative aspect-[4/3] lg:aspect-[16/10] rounded-3xl overflow-hidden bg-[#0a1a0c] border border-[#00e676]/[0.08]">
              {/* Glow */}
              <div
              ...
              <div className="absolute bottom-5 right-5 flex gap-2 z-20">
                {[handlePrev, handleNext].map((fn, i) => (
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-[#030804]/60 backdrop-blur border border-[#00e676]/20 flex items-center justify-center text-[#e8f5e9] hover:bg-[#00e676]/15 hover:border-[#00e676]/40 transition-all active:scale-90"
                  >
